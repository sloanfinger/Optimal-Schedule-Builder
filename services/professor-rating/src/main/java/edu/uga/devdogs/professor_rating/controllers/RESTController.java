...
public class RESTController {
  ...
  public double getAggregateHelpfulnessRating(
    @RequestParam(required = true) String professorName,
  ...
  public double isAttendanceMandatory(
    @RequestParam(name = "professorName", required = true) String professorName,
