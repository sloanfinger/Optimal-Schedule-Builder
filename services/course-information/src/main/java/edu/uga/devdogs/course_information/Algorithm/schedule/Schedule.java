...
public class Schedule {
  ...
  public Schedule(Set<Section> sections) {
    ...
    for (Section section : sections) {
      ...
      for (Class _class : section.classes()) {
        // Iterates through all classes in the current section
        for (DayOfWeek day : _class.days()) {
          // Iterates through all days in the current class
